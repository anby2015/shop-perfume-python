...
urlpatterns = patterns('',
    ...
    url(r'^cart/remove/(?P<itemid>[\d]+)/(?P<last_url>[-\w]+)/$', cart_views.cart_remove, name='remove_cart'),
    url(r'^cart/configure/(?P<itemid>[\d]+)/$', cart_views.cart_config, name='config_cart'),
