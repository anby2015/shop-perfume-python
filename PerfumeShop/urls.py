...
urlpatterns = patterns('',
    url(r'^index/$', views.index, name='index_start'),
    ...
    url(r'^cart/remove/(?P<itemid>[\d]+)/(?P<last_url>[-_\w]+)/$', cart_views.cart_remove, name='remove_cart'),
    url(r'^cart/configure/(?P<product_id>[\d]+)/$', cart_views.cart_config, name='config_cart'),
